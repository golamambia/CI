...
class Sales_order extends CI_Controller {
	...
	public function index()
	{
        ...
        $data3=$this->input->post('category');
        if($data1!='' && $data2!='' && $data3==''){
            $query=$this->General_model->show_data_date2('sales_order',$data1,$data2,$data3,'get','order_date','price','DESC');
        $data['sales']=$query;
        $data['dt1']=$data1;
        $data['dt2']=$data2;
        ...
        $this->load->view('superpanel/sales_order');
